...
public class LsWFragment extends Fragment {
    ...
    public class LswWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            view.loadUrl("javascript: function reformat_mobile() { document.getElementById(\"header-menu\").parentNode.removeChild(document.getElementById(\"header-menu\")); document.querySelector(\"body\").style.paddingTop = \"20px\"; } reformat_mobile(); ");
        }
    }
    ...
    public void loadCategory(int position){
        ...
        switch (position) {
            ...
            case 6:
                ...
                break;
            case 7:
                mWebView.loadUrl(mainSite + "/notifications");
                break;
            case 8:
